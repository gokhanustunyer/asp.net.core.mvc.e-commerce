...
namespace eticaret.data.Migrations
{
    ...
    [Migration("20231026175233_AddCategoryImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryCategoryImage", b =>
                {
                    b.Property<Guid>("CategoryId")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("CategoryImagesId")
                        .HasColumnType("char(36)");

                    b.HasKey("CategoryId", "CategoryImagesId");

                    b.HasIndex("CategoryImagesId");

                    b.ToTable("CategoryCategoryImage");
                });
            ...
            modelBuilder.Entity("CommentImageProductComment", b =>
                {
                    ...
                    b.HasKey("ImagesId", "ProductCommentId");

                    b.HasIndex("ProductCommentId");

                    b.ToTable("CommentImageProductComment");
                });
            ...
            modelBuilder.Entity("eticaret.entity.Category.CategoryImage", b =>
                {
                    b.HasBaseType("eticaret.entity.File");
            ...
            modelBuilder.Entity("eticaret.entity.Product.CommentImage", b =>
                {
                    b.HasBaseType("eticaret.entity.File");

                    b.HasDiscriminator().HasValue("CommentImage");
                });
            ...
            modelBuilder.Entity("CategoryCategoryImage", b =>
                {
                    ...
                    b.HasOne("eticaret.entity.Category.CategoryImage", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CommentImageProductComment", b =>
                {
                    b.HasOne("eticaret.entity.Product.CommentImage", null)
                        .WithMany()
                        .HasForeignKey("ImagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eticaret.entity.Product.ProductComment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eticaret.entity.Product.Product", b =>
                {
                    b.HasOne("eticaret.entity.Identity.AppUser", "Publisher")
                        .WithMany()
